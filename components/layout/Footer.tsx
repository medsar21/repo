  ...
  return (
    <footer className="bg-gradient-to-br from-maroc-dark via-[#0a1f1a] to-maroc-green/20 text-white relative overflow-hidden border-t-4 border-maroc-gold">
      <div className="container mx-auto px-6 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 py-6 md:py-8">
          {/* Colonne 1 - Équipe Nationale du Maroc */}
          <div>
            <h3 className="text-xs md:text-sm font-semibold text-white/60 mb-3 tracking-wide">
          ...
          <div>
            ...
            <p className="text-[10px] md:text-xs text-white/70 mb-3 leading-relaxed">
            ...
            <div className="space-y-1.5">
              <a
                href="#"
                className="block w-full max-w-[140px] h-9 bg-white/10 hover:bg-white/20 rounded-lg border border-white/20 flex items-center justify-center gap-1.5 transition-colors group"
              >
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
                </svg>
                <div className="text-left">
                  <div className="text-[9px] text-white/60 leading-tight">Télécharger dans</div>
                  <div className="text-xs font-semibold leading-tight">l'App Store</div>
                </div>
              </a>
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-[9px] text-white/60 leading-tight">DISPONIBLE SUR</div>
        ...
        {/* Section des logos - complètement visibles */}
        <div className="relative py-6 md:py-8 flex items-center justify-between border-t border-white/10">
          {/* Logo DIMA MAGHRIB - gauche */}
          <div className="flex-shrink-0">
            <Image
              ...
              width={400}
              height={100}
              className="w-32 md:w-48 lg:w-56 h-auto opacity-90"
            />
          </div>
